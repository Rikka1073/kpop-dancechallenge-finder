          ...
          <div className="container mx-auto">
            <div className="mx-auto max-w-5xl">
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <Link
                  href="/search"
                  className="btn btn-lg btn-outline md:btn-xl active:bg-accent rounded-2xl text-lg text-purple-600 hover:bg-purple-600 hover:text-white active:text-white"
                >
                  詳しく見る
                  <ArrowRight />
                </Link>
